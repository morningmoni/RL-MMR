...
from utils import PAD, UNK, get_gpu_memory_map, print_config
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', help='root of the model', default='saved_model/debug_ext_ml/del')
    ...
    parser.add_argument('--w2v', action='store', default='word2vec.128d.226k.bin',
    ...
    # length limit
    parser.add_argument('--max_word', type=int, action='store', default=200,
                        help='maximun words in a single article sentence')
    parser.add_argument('--max_sent', type=int, action='store', default=2000,
